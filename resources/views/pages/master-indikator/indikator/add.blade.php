...
<div class="dashboard-section">
    ...
    <div class="section-body">
        <form action="{{ route('master-indikator.store') }}" method="POST" class="space-y-4" onsubmit="confirmSubmit(event)">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="number" name="target_percentage" id="target_percentage" 
                        ...
                        value="{{ old('target_percentage') }}" min="0" max="100" step="0.01" required>
