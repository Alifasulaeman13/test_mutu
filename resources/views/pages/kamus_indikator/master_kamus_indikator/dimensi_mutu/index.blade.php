...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('dimensi_mutu.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition duration-200">
            ...
            <x-slot name="body">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <x-action-buttons :edit-url="route('dimensi_mutu.edit', $item->id)" :delete-url="route('dimensi_mutu.destroy', $item->id)" confirm="Apakah Anda yakin ingin menghapus data ini?" />
                    </td>
                </tr>
                @empty
                <tr>
